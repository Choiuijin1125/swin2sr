...
def main():
    ...
    parser.add_argument('--model_path', type=str,
                        default='model_zoo/swin2sr/Swin2SR_ClassicalSR_X4_64.pth')
    ...
    ############################################### need to modify ###############################################
        ...
        url = 'https://github.com/Choiuijin1125/swin2sr/releases/download/v0.0.1/{}'.format(os.path.basename(args.model_path))
